            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-info btn-sm" href="{{ route('dream.create') }}">
                            <i class="fas fa-plus">
                            </i> جديد</a>
                                ...
                                <tr>
                                    ...
                                    <td> <a class="btn btn-info btn-sm" href="{{ route('dream.edit', $dream->id) }}">
                                        ...
                                        <form action="{{ route('dream.destroy', $dream->id) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" id="del-{{ $dream->id }}"
                                                class="btn btn-danger btn-sm delete" data-toggle="modal"
                                                data-target="#modal-delete" title="حذف"> <i class="fas fa-trash">
                                                </i>حذف</button>
                                        </form>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog  modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between" style="border-top: 0px solid  ">
                    <button class="btn ripple btn-secondary" id="btn-cancel-modal" data-dismiss="modal"
                        type="button">{{ __('general.cancel', [], 'ar') }}</button>

                    <button class="btn ripple btn-danger " id="btn-modal-del"
