            ...
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-info btn-sm" href="{{ url('admin/setting/createbody') }}">
                            <i class="fas fa-plus">
                            </i> جديد</a>
                ...
                <div class="card-body  row">
                    <div class="col-lg-12">
                        ...
                        @endphp
                        @foreach ($List as $row)
                            <form action="{{ url('admin/setting/updatebody', [$row->id]) }}"
                                id="footer-form-{{ ++$i }}" method="POST" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="col-sm-12" style="text-align: left">
                                <form method="POST" action="{{ url('admin/setting/delbody', $row->id) }}">
                                    @csrf
                                    @method('DELETE')
